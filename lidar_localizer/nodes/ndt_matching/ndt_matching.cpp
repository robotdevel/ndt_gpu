...
{
  ROS_INFO("received initial data from rviz!!!!!!!!");
  ...
  ROS_INFO("x : %lf, y : %lf, z : %lf, roll : %lf, pitch : %lf, yaw : %lf", current_pose.x, current_pose.y, current_pose.z, current_pose.roll, current_pose.pitch, current_pose.yaw);
...
static void points_callback(const sensor_msgs::PointCloud2::ConstPtr& input)
{
  ...
  if (map_loaded == 1 && init_pos_set == 1)
  {
    ...
    */
    ...
    std::cout << "cuda found? : " << cuda_find << std::endl;
    std::cout << "-----------------------------------------------------------------" << std::endl;
...
int main(int argc, char** argv)
{
  ...
  ROS_INFO("test3");
  ROS_INFO("MethodType::PCL_ANH_GPU %d", MethodType::PCL_ANH_GPU);
//#ifndef CUDA_FOUND
